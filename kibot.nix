{ lib, pkgs, buildPythonPackage, fetchFromGitHub, pytest, pytest-cov, coverage, pyyaml, XlsxWriter, requests, colorama, kiauto, kicad, kibom, InteractiveHtmlBom, KiCost, PcbDraw, librsvg, imagemagick }:
...
buildPythonPackage rec {
  ...
  '';
  propagatedBuildInputs = [ pyyaml XlsxWriter requests colorama kiauto kicad kibom pkgs.zip pkgs.unzip pkgs.gnutar InteractiveHtmlBom KiCost pkgs.xlsx2csv PcbDraw librsvg imagemagick ];
